            ...
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    function g(a) {
						...
						/*LE NON RESPECT TOTAL DU JS*/
							$("#view-nom").html(i.getAttribute("data-nom"));
							$("#view-description").html(i.getAttribute("data-description"));
							$("#view-categorie").html(i.getAttribute("data-categorie"));
							$("#view-categorie").attr("class",i.getAttribute("data-couleur"));
                            var stars="";
                            for(var cpt=0;cpt<Math.floor(i.getAttribute("data-note")/2);cpt++)stars+="star ";
                            if(i.getAttribute("data-note")%2>0)stars+="star_half";
							$("#view-note").html(stars);
							$("#view-note").attr("class",i.getAttribute("data-couleur")+" material-icons");
							$("#view-btn").attr("class","btn waves-effect waves-light "+i.getAttribute("data-couleur").replace('-text',''));
							$("#view-btn").attr("href",i.getAttribute("data-href"));
