...
if(isset($variables['categorie'][0]))echo str_replace('-text','',$variables['categorie'][0]['color']).' darken-2';else echo 'brown darken-4';?>">
            ...
            <div class="col l6 s12">
                ...
                <form id="recherche">
					<div class="input-field">
						<i class="prefix brown-text text-lighten-2 material-icons pointer hover-white" onclick="$('#recherche').submit()">search</i>
						<input type="text" id="search" name="search" required>
						<label for="search">Critère de recherche ...</label>
					</div>
				</form>
				<br/>
				<h5 class="white-text hidden-on-med-and-down">La zone inutile du footer</h5>
            </div>
    ...
    <div class="footer-copyright">
        <div class="wrap">
            © 2016 H1RM1 | Geoffrey Hermin & Christophe Hachin
